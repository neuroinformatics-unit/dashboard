...
cache_path = Path.home() / ".dashboard" / "data"
niu_data, niu_date = format_data(cache_path / "data_neuroinformatics-unit.json")
brainglobe_data, brainglobe_date = format_data(cache_path / "data_brainglobe.json")
